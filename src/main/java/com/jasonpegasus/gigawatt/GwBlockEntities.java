...
public class GwBlockEntities {
    ...
    public static final Supplier<BlockEntityType<Battery_BE>> BATTERY_BE =
            BLOCK_ENTITIES.register("battery_be", () -> BlockEntityType.Builder.of(Battery_BE::new, GwBlocks.BATTERY.get()).build(null));
