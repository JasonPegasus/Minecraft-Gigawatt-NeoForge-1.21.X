...
public class GwLang extends Lang {
    public static MutableComponent translateDirect(String key, Object... args) {
        Object[] args1 = LangBuilder.resolveBuilders(args);
        return Component.translatable(Gigawatt.MOD_ID + "." + key, args1);
    }
    ...
    { return Component.translatable(Gigawatt.MOD_ID + "." + key); }

    //

    public static LangBuilder builder() {
        return new LangBuilder(Gigawatt.MOD_ID);
    }
