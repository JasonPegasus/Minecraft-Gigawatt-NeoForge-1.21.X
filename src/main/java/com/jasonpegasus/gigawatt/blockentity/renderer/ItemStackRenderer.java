...
public class ItemStackRenderer implements BlockEntityRenderer {
    public ItemStackRenderer(BlockEntityRendererProvider.Context context, ItemStackHandler inventory) {
